...
`,o=i.default.h2.withConfig({displayName:"Section__SectionTitle",componentId:"sc-7657ac1f-1"})`
  ...
  color: #9ca3af;
  margin-bottom: 20px;
`,s=({title:e,children:i})=>(0,t.jsxs)(n,{children:[(0,t.jsx)(o,{children:e.toUpperCase()}),i]}),r=i.default.header.withConfig({displayName:"ResumeHeader__HeaderWrap",componentId:"sc-fc851830-0"})`
  margin-bottom: 96px;
`,a=i.default.h1.withConfig({displayName:"ResumeHeader__Name",componentId:"sc-fc851830-1"})`
  font-size: 36px;
  font-weight: 700;
...
`,d=i.default.p.withConfig({displayName:"ResumeHeader__Summary",componentId:"sc-fc851830-3"})`
  margin-top: 28px;
  font-size: 15px;
  line-height: 1.7;
  color: #d1d5db;
...
Comfortable owning frontend architecture end-to-end in remote and freelance contexts.`,highlight:["UI Architect","Frontend Engineer","TypeScript","React","Storybook","PWA","offline-first"]});e.i(29785);var y=e.i(83606);let j=()=>{let e=y.allWorks.sort((e,t)=>(e.order??0)-(t.order??0));return(0,t.jsxs)(t.Fragment,{children:[e.map(e=>(0,t.jsx)(u,{title:`${e.resume.title} — ${e.resume.role}`,sub:e.resume.skills.join(" · "),desc:e.resume.description},e.slug)),(0,t.jsx)(u,{title:"Asharyu Design System — Author",sub:"TypeScript · React · Storybook",desc:"A Storybook-based component library designed to support consistent UI patterns and component reuse across projects."})]})},w=i.default.ul.withConfig({displayName:"ResumeSkill__SkillList",componentId:"sc-c888735a-0"})`
  display: flex;
  flex-wrap: wrap;
  gap: 10px 16px;
  font-size: 14px;
...
`,C=()=>(0,t.jsxs)(S,{children:[(0,t.jsx)(k.default,{href:"https://github.com/yoonjonglyu",target:"_blank",rel:"noopener noreferrer",children:"GitHub"}),"·",(0,t.jsx)(k.default,{href:"mailto:yoonjonglyu@gmail.com",target:"_blank",rel:"noopener noreferrer",children:"Email"}),"·",(0,t.jsx)(k.default,{className:"disabled",href:"https://www.linkedin.com/in/dev-isa-ryu-b081171b9/",target:"_blank","aria-disabled":"true",rel:"noopener noreferrer",children:"LinkedIn"})]}),R=i.default.main.withConfig({displayName:"Resume__Container",componentId:"sc-86caea03-0"})`
  width: 794px;
  min-height: 1123px;
  margin: 0 auto;
  padding: 64px 56px;
  ...
  font-size: 14px;
  line-height: 1.6;
`,N=i.default.div.withConfig({displayName:"Resume__PageBreak",componentId:"sc-86caea03-1"})`
  page-break-before: always;
`;e.s(["default",0,()=>(0,t.jsxs)(R,{children:[(0,t.jsx)(c,{}),(0,t.jsx)(s,{title:"Focus",children:(0,t.jsx)(b,{})}),(0,t.jsx)(N,{}),(0,t.jsx)(s,{title:"Work",children:(0,t.jsx)(j,{})}),(0,t.jsx)(s,{title:"Skills",children:(0,t.jsx)(I,{})}),(0,t.jsx)(s,{title:"contact",children:(0,t.jsx)(C,{})})]})],55319)}]);