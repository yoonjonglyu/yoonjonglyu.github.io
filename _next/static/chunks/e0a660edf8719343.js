...
`;var s=(0,t.default)(o.default).withConfig({displayName:"ContentsCard___StyledCard",componentId:"sc-2d49bd79-2"})`
        ...
        ${e=>e.$_css}
      `;e.s(["default",0,({header:e,contents:t,CSS:o})=>(0,r.jsxs)(s,{$_css:o,children:[(0,r.jsx)(c,{children:e}),(0,r.jsx)(p,{children:(0,r.jsx)(l,{code:t})})]})],83688)},74832,e=>{"use strict";var r=e.i(43476),t=e.i(97053),o=e.i(22016),n=e.i(83688);let i=t.default.div.withConfig({displayName:"PackageArticle__Container",componentId:"sc-9bf50b34-0"})`
  display: flex;
  flex-direction: row;
  gap: 18px;
  margin: 24px 3px;
...
`,a=t.default.section.withConfig({displayName:"PackageArticle__ArticleArea",componentId:"sc-9bf50b34-1"})`
  flex: 3;
  display: flex;
...
`,d=t.default.div.withConfig({displayName:"PackageArticle__ArticleLinkConainer",componentId:"sc-9bf50b34-2"})`
  display: flex;
  flex-direction: row;
  height: auto;
  gap: 12px;
`;e.s(["default",0,({title:e,content:t,repository:l,homepage:c})=>(0,r.jsx)(i,{children:(0,r.jsxs)(a,{children:[(0,r.jsx)(n.default,{header:e||"pacakge",contents:t}),(0,r.jsxs)(d,{children:[(0,r.jsx)(o.default,{href:"/archive",style:{textDecoration:"none"},children:"← Back to Archive"}),(0,r.jsx)(o.default,{href:l,style:{textDecoration:"none"},target:"_blank",rel:"noopener noreferrer",children:"Github"}),(0,r.jsx)(o.default,{href:c,style:{textDecoration:"none"},target:"_blank",rel:"noopener noreferrer",children:"NPM"})]})]})})])}]);